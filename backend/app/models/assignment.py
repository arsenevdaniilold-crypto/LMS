...
class Assignment(Base):
    ...
    type: Mapped[AssignmentType] = mapped_column(SAEnum(AssignmentType, name="assignment_type", create_type=False), nullable=False)
    grade_type: Mapped[GradeType] = mapped_column(SAEnum(GradeType, name="grade_type", create_type=False), nullable=False)
    grading_type: Mapped[GradingType | None] = mapped_column(SAEnum(GradingType, name="grading_type", create_type=False), nullable=True)
...
class AssignmentMaterial(Base):
    ...
    material_type: Mapped[MaterialType] = mapped_column(SAEnum(MaterialType, name="material_type", create_type=False), nullable=False)
